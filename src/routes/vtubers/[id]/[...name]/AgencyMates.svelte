<script lang="ts">
	...
	import AgencyMatesLayout from './AgencyMatesLayout.svelte';
	import AgencyMatesSort from './AgencyMatesSort.svelte';
...
<div class="grid grid-cols-6 gap-2">
	<div class="col-span-6 flex gap-2">
		...
		{#if open}
			<AgencyMatesSort bind:value={sort} />
			<AgencyMatesLayout bind:value={layout} />
		{/if}
		<div>
