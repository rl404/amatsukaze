...
<div class="absolute top-0 p-2 w-full flex justify-between items-center">
	<div class="flex">
		...
		<div class="p-2 bg-white border border-yellow-500 mr-2 ml-2 rounded-full">
			<div class="h-4 leading-4 overflow-hidden">Vtuber Family Tree</div>
		</div>
	</div>
	<div class="flex">
...
{#if helpShow}
	<div class="absolute right-2 bg-white" style="top:50px;">
		<div class="border border-yellow-500 rounded-lg p-2 grid grid-cols-1 gap-1 w-52">
			...
			<div>
				<span
					class="h-3 w-3 text-purple-500 inline-block ml-1.5 mr-3 text-center font-bold pointer-events-none"
					>—</span
				>2D/3D Modeler
			</div>
