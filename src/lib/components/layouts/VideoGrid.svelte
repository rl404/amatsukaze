<script lang="ts">
	...
	const durationStr = duration === 0 ? '' : new Date(duration).toISOString().slice(duration / 1000 >= 3600 ? 11 : 14, 19);
...
<div class={className}>
	<div class="flex flex-col gap-1">
		...
		<a class="text-sm line-clamp-2" href={data.url} target="_blank" rel="noreferrer">
			{data.title}
		</a>
